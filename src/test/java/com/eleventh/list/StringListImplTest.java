...
class StringListImplTest {
    ...
    private static final String ITEM_4 = "4";
    ...
    @BeforeEach
    void setUp() {
        out = new StringListImpl(INITIAL_CAPACITY);
        out.add(ITEM_0);
        out.add(ITEM_1);
        out.add(ITEM_2);
    }
    ...
    void equalsWithValidList() {
        StringList expected = new StringListImpl(INITIAL_CAPACITY);
        expected.add(ITEM_0);
        expected.add(ITEM_1);
        expected.add(ITEM_2);
    ...
    void toArrayListWithItems() {
        String[] expected = new String[]{ITEM_0, ITEM_1, ITEM_2};
